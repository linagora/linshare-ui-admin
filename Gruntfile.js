...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      js: {
        files: ['<%= yeoman.app %>/scripts/{,*/}*.js', '<%= yeoman.app %>/ng_components/**/{,*/}*.js'],
    ...
    // ngAnnotate adds and removes AngularJS dependency injection annotations.
    // It makes your code safe for minification.
    ngAnnotate: {
      dist: {
        files: [{
          expand: true,
