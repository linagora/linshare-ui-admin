...
import { getLayoutEmailTemplates, getMailConfigurationFooterList } from '../services/email-templates-api';
...
export default function useEmailTemplatesFooter() {
  ...
  async function handleGetEmailFootersTemplates(domainUuid: string) {
    try {
  ...
  return {
    ...
    pagination,
    filterText,
    handleGetEmailFootersTemplates,
