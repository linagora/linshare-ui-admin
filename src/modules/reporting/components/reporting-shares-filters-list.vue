...
const { domains, beginDate, endDate, top } = storeToRefs(useReportingSharesStore());
const { t, d } = useI18n();
...
<template>
  <div class="filter-list">
    ...
    <div class="filter">
      <span class="filter__type">{{ $t('REPORTING.FILTERS_BAR.TOP') }}</span>
      <ls-tag :value="`${top}`"></ls-tag>
    </div>
    <div class="filter">
