...
import DomainWelcomeMessagesLargeTable from '@/modules/domain/components/domain-welcome-messages-large-table.vue';
import DomainWelcomeMessagesSmallTable from '@/modules/domain/components/domain-welcome-messages-small-table.vue';
