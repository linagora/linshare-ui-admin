<template>
  <a-card flat :bordered="false" class="delete-contact-fail-card">
    <span class="delete-contact-fail-card__icon">
      <warning-icon width="36" height="36"></warning-icon>
    </span>
    <div class="delete-contact-fail-card__content">
      <strong>{{ $t('EMAIL_TEMPLATES.DELETE_CONTENT_MODAL.DELETE_FAILURE') }}</strong>
      <span>{{ deleteMessage }}</span>
    </div>
    <div class="delete-contact-fail-card__actions">
