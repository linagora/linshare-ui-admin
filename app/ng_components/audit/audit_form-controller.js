...
angular.module('linshareAdminApp')
  .controller('AuditFormCtrl',
    ['$rootScope', '$scope', '$filter', '$log', '$translate', '$locale', 'ngTableParams', 'Audit', 'selectOptions', 'authenticatedUser',
    function($rootScope, $scope, $filter, $log, $translate, $locale, ngTableParams, Audit, selectOptions, authenticatedUser) {
      $scope.criteria = {};
      $scope.actorMails = '';
      $scope.targetMails = '';
